...
(* OASIS_START *)
(* DO NOT EDIT (digest: e3c55f2c0c2146cde7635022e264d9de) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://www.raytracerchallenge.com";
          bugreports = None;
          synopsis =
            "A ray tracer implementation from the \"Ray Tracer Challenge\" book";
          description =
            Some [OASISText.Para "The Ray Tracer Challenge, by Jamis Buck."];
          tags = [];
          categories = [];
          files_ab = [];
          sections =
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "progs";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "rtc"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "chapter.ml"})
            ];
     ...
     oasis_digest = Some "W&\128\130\b\161\181F\207\138Hd\250\132\132B";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
